...
# my_tree.insert(parent='', index='end', iid=0, text='Parent', values=("John", 1, "Peperron"))
...
# my_tree.insert(parent='', index='end', iid=4, text='Parent', values=("Erin", 5, "onion"))
# # Child
# my_tree.insert(parent='', index='end', iid=5, text='Parent', values=("John", 1.2, "Peperron"))
# my_tree.move('5', '0', '0')
