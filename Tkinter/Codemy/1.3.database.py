...
conn = sqlite3.connect("db/address_book.db")
...
f_name_label.grid(row=0, column=0, pady=(10, 0))
f_name_label = Label(root, text="Last Name")
f_name_label.grid(row=1, column=0)
f_name_label = Label(root, text="Address")
f_name_label.grid(row=2, column=0)
f_name_label = Label(root, text="City")
f_name_label.grid(row=3, column=0)
f_name_label = Label(root, text="State")
f_name_label.grid(row=4, column=0)
f_name_label = Label(root, text="Zipcode")
f_name_label.grid(row=5, column=0)
